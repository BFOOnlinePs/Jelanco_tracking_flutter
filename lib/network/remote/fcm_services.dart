...
class FCMServices {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        await CacheHelper.saveData(
            key: MyCacheKeys.firebaseToken, value: token);
  ...
  static Future<void> deleteFCMTokenFromLocalAndServer(String fcmToken) async {
    ...
    print('Request URL: ${EndPointsConstants.baseUrl + EndPointsConstants.deleteFcmUserTokenEndPoint}');
