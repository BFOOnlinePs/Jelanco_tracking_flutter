              ...
              attachmentsCategories!.images!.isNotEmpty ||
                  ...
                  ? SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemCount: attachmentsCategories!.images!.length +
                            attachmentsCategories!.videos!.length,
                        itemBuilder: (context, index) {
                          ...
                          if (index < attachmentsCategories!.images!.length) {
                            ...
                            // This is a video
                            int videoIndex =
                                index - attachmentsCategories!.images!.length;
                                ...
                                child: Stack(
                                  children: [
                                    MyThumbnailVideo(
                                      ...
                                      height: 220,
                                      showVideoIcon: true,
                                      thumbnail: attachmentsCategories!
                                                  .videos![videoIndex]
                                                  .thumbnail !=
                                              null
