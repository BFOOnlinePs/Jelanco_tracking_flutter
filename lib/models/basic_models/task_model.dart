...
class TaskModel {
  ...
  factory TaskModel.fromMap(Map<String, dynamic> json) => TaskModel(
        ...
        assignedToUsers:
            json["assigned_to_users"] == null ? [] : List<UserModel>.from(json["assigned_to_users"]!.map((x) => UserModel.fromMap(x))),
        ...
        taskAttachmentsCategories:
            json["task_attachments_categories"] == null ? null : AttachmentsCategories.fromMap(json["task_attachments_categories"]),
