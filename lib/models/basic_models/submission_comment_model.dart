...
class SubmissionCommentModel {
  ...
  factory SubmissionCommentModel.fromMap(Map<String, dynamic> json) => SubmissionCommentModel(
    tscId: json["tsc_id"],
    ...
    commentedByUser: json["commented_by_user"] == null ? null : UserModel.fromMap(json["commented_by_user"]),
  );
