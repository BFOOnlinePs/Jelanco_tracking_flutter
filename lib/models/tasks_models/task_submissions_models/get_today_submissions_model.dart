...
class GetTodaySubmissionsModel {
  final bool? status;
  ...
  factory GetTodaySubmissionsModel.fromMap(Map<String, dynamic> json) =>
      GetTodaySubmissionsModel(
        status: json["status"],
        ...
        submissions: json["submissions"] == null
            ? []
            : List<TaskSubmissionModel>.from(json["submissions"]!
  ...
  Map<String, dynamic> toMap() => {
        ...
        "submissions": submissions == null
            ? []
            : List<dynamic>.from(submissions!.map((x) => x.toMap())),
      };
}
